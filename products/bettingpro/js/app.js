...
import { shinProbabilities } from './shin.js?v=1788452064';
import { calculateEdge, kellyFraction, kellyStake } from './kelly.js?v=1788452064';
import { buildEloTable, renderEloTable } from './elo-display.js?v=1788452064';

import { loadMeta, loadLeagueData, loadPreviousSeasons, loadPredictions, loadSuggestedBets, API_BASE } from './data-loader.js?v=1788452064';
import { getSportDefaults } from './sport-config.js?v=1788452064';
import { computeSplitGroups } from './split-stage.js?v=1788452064';
import { computeNhlGroups } from './nhl-structure.js?v=1788452064';
import { isKnockoutStage, KNOCKOUT_STAGE_ORDER } from './knockout.js?v=1788452064';
import { t, getLang, onLangChange, applyStaticTranslations, translateCountrySuffix } from './i18n.js?v=1788452064';
import {
...
function updateEloTable() {
  ...
  let initialRatings = {};
  if (!seasonOnly && previousSeasonMatches.length > 0) {
...
/** Match-depth setting from the slider (null = all matches). Module-level so both
 * analyzeMatch and the init-scope helpers can use it. */
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  document.getElementById('slider-panel-close')?.addEventListener('click', closeResults);
