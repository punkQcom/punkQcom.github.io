...
import { expectedGoals, scoreMatrix } from './poisson.js?v=1775473323';
import { applyDixonColes } from './dixon-coles.js?v=1775473323';
import { shinProbabilities } from './shin.js?v=1775473323';
import { calculateEloRatings, eloToPoisson } from './elo.js?v=1775473323';
import { calculateTeamAverages, calculateLeagueAvg } from './sources/league-data.js?v=1775473323';
